...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'rally_car.urdf'
    xacro_file = "rally_car.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "rally_car"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("rally_car"), "rviz", "display_default.rviz"]
    )
